...
//     description: 'Transform your innovative ideas into actionable plans. We help refine and validate your concept, ensuring it addresses real market needs.',
//   },
//   {
//     id: 'design',
//     name: 'Design',
//     title: 'Design for Impact',
//     description: 'Create intuitive and engaging user experiences. Our design process focuses on both aesthetics and functionality to captivate your audience.',
//   },
//   {
//     id: 'develop',
//     name: 'Develop',
//     title: 'Build with Excellence',
//     description: 'Turn designs into robust, scalable solutions using cutting-edge technology and best development practices.',
//   },
//   {
//     id: 'launch',
//     name: 'Launch',
//     title: 'Ready for Takeoff',
//     description: 'Launch your product with confidence. We ensure a smooth deployment and provide ongoing support for continuous growth.',
//   },
// ];
...
//                 <div className="absolute top-1/4 right-1/4 w-4 h-4 bg-blue-400 rounded-full animate-pulse" />
//                 <div className="absolute bottom-1/3 left-1/3 w-3 h-3 bg-white rounded-full animate-pulse delay-75" />
//                 <div className="absolute top-1/2 left-1/4 w-2 h-2 bg-gray-400 rounded-full animate-pulse delay-150" />
//               </div>
...
//             Launching is just the beginning, we ensure your product makes a splash and
//             keeps making waves, ensuring a continual customer acquisition.
//           </p>
//         </div>
//       </div>
//     </section>
            ...
            <div className="aspect-[4/3] relative overflow-hidden rounded-3xl bg-[#0F172A] p-8">
              ...
              <div className="relative h-full flex items-center justify-center transition-opacity duration-300">
                <img
                  ...
                  className="max-w-full h-auto rounded-2xl transition-all duration-300"
                />
              </div>
            </div>
          </div>
